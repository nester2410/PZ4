...
class SpectrumAndReflection:
    ...
    def Spectrum(self):
        ...
        self.fallSignal = numpy.zeros(self.maxTime)
        self.fallSignal[:200] = self.probes[1].E[:200]

        # Получение спектра падающего сигнала
        self.fSpectrum = numpy.abs(fft.fft(self.fallSignal, self.size))
